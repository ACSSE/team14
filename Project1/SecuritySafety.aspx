<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="SecuritySafety.aspx.vb" Inherits="Project1.SecuritySafety" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MyBody" runat="server">
     <div class="trending-ads">
				...
				<div class="trend-ads">
					<h3>Security fire and Safety</h3><br/>
							<ul id="flexiselDemo3">
								<li>
									<div class="col-md-3 biseller-column">
										<a href="#">
											<img src="images/imagesF/f2.png"/>
										</a> 
										<div class="ad-info">
											<h5>Specialist</h5>
					...
					<script type="text/javascript">
                     ...
                     <div class="modal-header" >
                        ...
                        <a style="text-align:end;margin-left:20px" href="ClientOrWorker.aspx">Return-to-login-page</a>&nbsp;&nbsp;&nbsp;
                         <a href="FeaturedWorkers.aspx#parentVerticalTab5">Featured Workers</a>
                    </div>
