<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="mComplaint.aspx.vb" Inherits="Project1.mComplaint" %>
			...
			<div class="post-ad-form">
                ...
                <tr>
                    <td style="width: 300px; height: 50px;">
                        <asp:Label ID="lblTitle" ForeColor="Black"  runat="server" Text="Complaint Subject"></asp:Label></td>
                    ...
                    <td style="width: 300px; margin:initial;">
                        <asp:Label ID="lblDescription" ForeColor="Black"  runat="server" Text="Complaint Description"  ></asp:Label></td>
                    <td>
                     ...
                     <tr>
                    <td style="width: 300px; margin:initial;">
                        <asp:Label ID="lblLogo" runat="server" ForeColor="Black" Text="Photographic evidence (Optional)"></asp:Label></td>
                    <td>
                ...
                <input type="submit" runat="server" id="btnSubmit" value="Submit"/>
						</div>
