...
Public Class Site3
    ...
    Private Function countResponses() As String
        ...
        If count > 0 Then
            ...
            If count > 0 Then
                ...
                Else
                    Return "<small><a style="" font-size:small; color:yellow;"" href=WorkerProfile.aspx>(" & count & ")</a></small>&nbsp;&nbsp;&nbsp;"
    ...
    Private Function countMesseges() As String
        ...
        If count > 0 Then
            ...
            Else
                Return "<small><a style="" font-size:small; color:red;"" href=WorkerProfile.aspx>(" & count & ")</a></small>&nbsp;&nbsp;&nbsp;"
